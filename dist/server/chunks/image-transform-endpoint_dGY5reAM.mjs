...
}, "C:/Users/roman/Documents/dev/personal/trash/astro-css-repro/node_modules/astro/components/Image.astro", void 0);
//#endregion
...
}, "C:/Users/roman/Documents/dev/personal/trash/astro-css-repro/node_modules/astro/components/Picture.astro", void 0);
//#endregion
...
}, "C:/Users/roman/Documents/dev/personal/trash/astro-css-repro/node_modules/astro/components/Font.astro", void 0);
//#endregion
...
(function() {
	const regexes = [
		...
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.yarnrc)$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.yarnrc\.yml)$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)(?!\.{1,2}(?:\/|$))(?=.)[^/]*?\.(crt|pem|key|pfx|p12|p8|jks))$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.git(?:\/(?!\.{1,2}(?:\/|$))(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)|$))$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.dev\.vars)$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.dev\.vars\.[^/]*?\/?)$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.wrangler(?:\/(?!\.{1,2}(?:\/|$))(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)|$))$/i,
		/^(?:C:\/Users\/roman\/Documents\/dev\/personal\/trash\/astro-css-repro\/wrangler\.jsonc)$/i
	];
